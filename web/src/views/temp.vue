<template lang="">
  <div class = "box">
    ...
    <div class="search">		
				...
				<input type="search" v-model="searchForm.searchContent" @keyup.enter="search" placeholder="Type in something.">	
				<!-- <div @click="search" class="sea"></div> -->
				<router-link :to="'/result/' + " ><div @click="search" class="sea"></div></router-link>
			</div>
			<div class="list">			
