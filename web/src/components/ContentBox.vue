    ...
    <div class="Content">
      <div class="text_content">
        ...
        <div class="collection" v-if="dataInfo.isCollect != null">
          <el-button
            @click="collect(dataInfo.id)"
            :type="dataInfo.isCollect ? 'primary' : 'none'"
            icon="el-icon-star-off"
            circle
          >
          </el-button>
        </div>
        <p v-if="dataInfo.description != null" id="text">
...
export default {
  ...
  methods: {
    ...
    searchContent() {
      request
        .get("/queryById?id=" + this.$route.params.id)
        .then((successResponse) => {
